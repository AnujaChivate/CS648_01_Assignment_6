...
} else if(coinFlipResult === "heads" && choice.trim().toLowerCase() === "tails") {
    window.alert("The flip was heads but you chose tails...you lose!");
} else if(coinFlipResult === "tails" && choice.trim().toLowerCase() === "heads") {
    window.alert("The flip was tails but you chose heads...you lose!");
} else if(coinFlipResult === "tails" && choice.trim().toLowerCase() === "tails") {
